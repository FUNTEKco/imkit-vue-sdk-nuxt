import { e as x, c as O, g as m, k as P, h as p, j as w, l as c, m as A, n as I, t as E, o as N } from "./_baseUniq-CeeXjiQ4.js";
import { aU as g, aE as _, aV as $, aW as F, aX as M, aY as l, aZ as B, a_ as T, a$ as y, b0 as S } from "./lib-CEfjsT7q.js";
var G = /\s/;
function H(n) {
...
var b = Object.prototype, Z = b.hasOwnProperty, dn = _(function(n, r) {
  n = Object(n);
  var t = -1, i = r.length, a = i > 2 ? r[2] : void 0;
  for (a && $(r[0], r[1], a) && (i = 1); ++t < i; )
    for (var f = r[t], e = F(f), s = -1, d = e.length; ++s < d; ) {
      var u = e[s], h = n[u];
      (h === void 0 || M(h, b[u]) && !Z.call(n, u)) && (n[u] = f[u]);
    }
  return n;
});
function un(n) {
