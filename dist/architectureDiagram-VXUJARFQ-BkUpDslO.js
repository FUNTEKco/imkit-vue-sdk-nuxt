import { aL as Ze, _ as dt, H as ke, V as qe, l as Se, b as Qe, a as Je, p as Ke, q as je, g as _e, s as tr, y as er, D as rr, E as ir, F as ar, c as Ee, am as me, aM as pe, i as nr, d as or, x as sr, aN as hr, aO as lr } from "./lib-CEfjsT7q.js";
import { p as fr } from "./chunk-4BX2VUAB-Dv4GATgs.js";
import { p as cr } from "./mermaid-parser.core-fLM3zdVB.js";
import { c as Fe } from "./cytoscape.esm-DdQZKk9f.js";
...
function Be(I, D, A, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const r = or("body").append("div").attr("id", "cy").attr("style", "display:none"), e = Fe({
...
var Gr = /* @__PURE__ */ dt(async (I, D, A, P) => {
  ...
  await Sr(i, o, N), await Fr(t, o, N), Xe(N, o), qe(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Ur = { draw: Gr }, Vr = {
  parser: Ge,
  get db() {
    return new Pe();
