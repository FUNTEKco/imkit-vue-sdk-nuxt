import { defineComponent as ve, ref as H, shallowRef as we, onMounted as ke, watch as Se, onUnmounted as je, h as J, nextTick as Ce } from "vue";
const ce = /^[a-z0-9]+(-[a-z0-9]+)*$/, E = (e, o, t, i = "") => {
  const n = e.split(":");
  if (e.slice(0, 1) === "@") {
  ...
  if (t && i === "") {
    ...
    return o && !L(l, t) ? null : l;
  }
  return null;
}, L = (e, o) => e ? !!// Check prefix: cannot be empty, unless allowSimpleName is enabled
// Check name: cannot be empty
((o && e.prefix === "" || e.prefix) && e.name) : !1, le = Object.freeze(
  {
    left: 0,
    top: 0,
    width: 16,
...
function X(e, o) {
  const t = Pe(e, o);
  for (const i in _)
    i in D ? i in e && !(i in t) && (t[i] = D[i]) : i in o ? t[i] = o[i] : i in e && (t[i] = e[i]);
  return t;
}
function Te(e, o) {
...
function fe(e) {
  if (typeof e != "object" || e === null)
    return null;
  const o = e;
  if (typeof o.prefix != "string" || !e.icons || typeof e.icons != "object" || !$(e, Ee))
    return null;
  const t = o.icons;
  for (const n in t) {
    const s = t[n];
...
function v(e, o) {
  const t = N[e] || (N[e] = /* @__PURE__ */ Object.create(null));
  return t[o] || (t[o] = Oe(e, o));
}
function ae(e, o) {
  return fe(o) ? ue(o, (t, i) => {
...
function Ct(e, o) {
  let t = [];
  return (typeof e == "string" ? [e] : Object.keys(N)).forEach((n) => {
    (typeof n == "string" && typeof o == "string" ? [o] : Object.keys(N[n] || {})).forEach((r) => {
      const l = v(n, r);
      t = t.concat(
...
function z(e) {
  const o = typeof e == "string" ? E(e, !0, F) : e;
  if (o) {
    const t = v(o.provider, o.prefix), i = o.name;
...
function Ae(e, o) {
  ...
  if (!t)
    return !1;
  const i = v(t.provider, t.prefix);
  return o ? Le(i, t.name, o) : (i.missing.add(t.name), !0);
}
function Me(e, o) {
  if (typeof e != "object")
    return !1;
  if (typeof o != "string" && (o = e.provider || ""), F && !o && !e.prefix) {
    let n = !1;
    return fe(e) && (e.prefix = "", ue(e, (s, r) => {
      Ae(s, r) && (n = !0);
    })), n;
  }
  const t = e.prefix;
...
const pe = Object.freeze({
  ...
  // Transformations
  ...D
}), De = /(-?[0-9.]*[0-9]+[0-9.]*)/g, Ne = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function Y(e, o, t) {
  if (o === 1)
    return e;
...
function Qe(e, o, t) {
  const i = Re(e);
  return ze(i.defs, o + i.content + t);
}
...
function qe(e, o) {
  ...
  [t, i].forEach((m) => {
    ...
    I % 2 === 1 && (n.left !== n.top && (b = n.left, n.left = n.top, n.top = b), n.width !== n.height && (b = n.width, n.width = n.height, n.height = b)), a.length && (s = Qe(
      s,
      '<g transform="' + a.join(" ") + '">',
      "</g>"
    ));
  });
  const r = i.width, l = i.height, u = n.width, c = n.height;
  let f, d;
  r === null ? (d = l === null ? "1em" : l === "auto" ? c : l, f = Y(d, u / c)) : (f = r === "auto" ? u : r, d = l === null ? Y(f, c / u) : l === "auto" ? c : l);
  const p = {}, g = (m, a) => {
    Ue(a) || (p[m] = a.toString());
  };
  g("width", f), g("height", d);
  const y = [n.left, n.top, u, c];
...
const He = /\sid="(\S+)"/g, $e = "IconifyId" + Date.now().toString(16) + (Math.random() * 16777216 | 0).toString(16);
let Ve = 0;
function _e(e, o = $e) {
  const t = [];
  let i;
  ...
  return t.forEach((s) => {
    const r = typeof o == "function" ? o(s) : o + (Ve++).toString(), l = s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    e = e.replace(
...
const Q = /* @__PURE__ */ Object.create(null), P = [
  "https://api.simplesvg.com",
  "https://api.unisvg.com"
], A = [];
for (; P.length > 0; )
  P.length === 1 || Math.random() > 0.5 ? A.push(P.shift()) : A.push(P.pop());
Q[""] = W({
  resources: ["https://api.iconify.design"].concat(A)
});
function Ge(e, o) {
  const t = W(o);
  return t === null ? !1 : (Q[e] = t, !0);
}
function U(e) {
  return Q[e];
}
...
const Ze = (e, o, t) => {
  ...
  return t.forEach((u, c) => {
    l += u.length + 1, l >= n && c > 0 && (i.push(r), r = {
      type: s,
      provider: e,
      prefix: o,
      icons: []
...
function ot(e) {
  ...
  return e.forEach((n) => {
    if (i.name === n.name && i.prefix === n.prefix && i.provider === n.provider)
      return;
    i = n;
    const s = n.provider, r = n.prefix, l = n.name, u = t[s] || (t[s] = /* @__PURE__ */ Object.create(null)), c = u[r] || (u[r] = v(s, r));
    let f;
    ...
    o.forEach((s) => {
      ...
      r.pending = r.pending.filter((u) => {
        ...
        if (e.icons[c])
          ...
          return t = !0, !0;
        return !1;
      }), r.pending.length !== l && (t || me([e], s.id), s.callback(
        r.loaded.slice(0),
        r.missing.slice(0),
        r.pending.slice(0),
        s.abort
...
function ct(e, o = !0, t = !1) {
  const i = [];
  return e.forEach((n) => {
    const s = typeof n == "string" ? E(n, o, t) : n;
    s && i.push(s);
  }), i;
}
var lt = {
...
function ut(e, o, t, i) {
  ...
  function b(h, x, C) {
    ...
    if (O) {
      f = C, p.length || (r.length ? q() : w());
      return;
    }
    if (y(), I(), !e.random) {
      const k = e.resources.indexOf(h.resource);
      k !== -1 && k !== e.index && (e.index = k);
    }
    u = "completed", g.forEach((k) => {
      k(C);
    });
  }
  function q() {
...
function be(e, o, t) {
  ...
  if (typeof e == "string") {
    ...
    if (s) {
      i = ye(s);
      const r = e.resources ? e.resources[0] : "", l = B(r);
      l && (n = l.send);
    }
  }
  return !i || !n ? (t(void 0, 424), Z) : i.query(o, n, t)().abort;
}
function ee() {
}
function at(e) {
...
function pt(e, o) {
  e.iconsToLoad ? e.iconsToLoad = e.iconsToLoad.concat(o).sort() : e.iconsToLoad = o, e.iconsQueueFlag || (e.iconsQueueFlag = !0, setTimeout(() => {
    ...
    const { valid: r, invalid: l } = dt(n);
    if (l.length && T(e, l, null), !r.length)
      return;
    const u = i.match(ce) ? B(t) : null;
    if (!u) {
      T(e, r, null);
      return;
    }
    u.prepare(t, i, r).forEach((f) => {
      be(t, f, (d) => {
        T(e, f.icons, d);
      });
    });
...
const xe = (e, o) => {
  ...
  return i.pending.forEach((u) => {
    ...
    if (f === l && c === r)
      return;
    r = c, l = f, s.push(v(c, f));
    const d = n[c] || (n[c] = /* @__PURE__ */ Object.create(null));
    d[f] || (d[f] = []);
  }), i.pending.forEach((u) => {
    const { provider: c, prefix: f, name: d } = u, p = v(c, f), g = p.pendingIcons || (p.pendingIcons = /* @__PURE__ */ new Set());
    g.has(d) || (g.add(d), n[c][f].push(d));
  }), s.forEach((u) => {
    const c = n[u.provider][u.prefix];
    c.length && pt(u, c);
  }), o ? rt(o, i, s) : ee;
}, Ft = (e) => new Promise((o, t) => {
...
function ht(e, o) {
  ...
  for (const i in o) {
    ...
    i in pe ? (n === null || n && (s === "string" || s === "number")) && (t[i] = n) : s === typeof t[i] && (t[i] = i === "rotate" ? n % 4 : n);
  }
  return t;
}
const gt = /[\s,]+/;
function mt(e, o) {
  o.split(gt).forEach((t) => {
    switch (t.trim()) {
      case "horizontal":
        e.hFlip = !0;
        break;
...
function It(e) {
  return "data:image/svg+xml," + xt(e);
}
function vt(e) {
  return 'url("' + It(e) + '")';
}
...
const re = (e, o) => {
  const t = ht(ne, o), i = { ...wt }, n = o.mode || "svg", s = {}, r = o.style, l = typeof r == "object" && !(r instanceof Array) ? r : {};
  for (let m in o) {
    const a = o[m];
    if (a !== void 0)
      switch (m) {
        ...
        // Rotation as string
        case "rotate":
          typeof a == "string" ? t[m] = yt(a) : typeof a == "number" && (t[m] = a);
          break;
        // Remove aria-hidden
        case "ariaHidden":
        case "aria-hidden":
        ...
        default: {
          const S = M[m];
          S ? (a === !0 || a === "true" || a === 1) && (t[S] = !0) : ne[m] === void 0 && (i[m] = a);
        }
      }
  }
  const u = qe(e, t), c = u.attributes;
  if (t.inline && (s.verticalAlign = "-0.125em"), n === "svg") {
    ...
    let m = 0, a = o.id;
    return typeof a == "string" && (a = a.replace(/-/g, "_")), i.innerHTML = _e(u.body, a ? () => a + "ID" + m++ : "iconifyVue"), J("svg", i);
  }
  const { body: f, width: d, height: p } = e, g = n === "mask" || (n === "bg" ? !1 : f.indexOf("currentColor") !== -1), y = bt(f, {
    ...c,
    width: d + "",
    height: p + ""
  });
...
const St = {
  ...
  function i() {
    var c, f;
    t.value && ((f = (c = t.value).abort) == null || f.call(c), t.value = null);
  }
  const n = H(!!e.ssr), s = H(""), r = we(null);
  function l() {
    const c = e.icon;
    ...
    let f;
    if (typeof c != "string" || (f = E(c, !1, !0)) === null)
      return null;
    let d = z(f);
    if (!d) {
      const y = t.value;
  ...
  function u() {
    var f;
    const c = l();
    c ? c.data !== ((f = r.value) == null ? void 0 : f.data) && (r.value = c) : r.value = null;
  }
  return n.value ? u() : ke(() => {
    n.value = !0, u();
  }), Se(() => e.icon, u), je(i), () => {
...
export {
  ...
  xe as loadIcons,
  _e as replaceIDs,
  Ot as setCustomIconLoader,
  Et as setCustomIconsLoader
};
