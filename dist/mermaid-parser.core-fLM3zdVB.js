...
import { bE as Tc, bF as Rc, aY as xl, bo as vc, b0 as Ac, aZ as te, aE as Ec, aF as ga, be as kc, bh as Sl, bi as Il, bf as $c, bt as ya, aH as Et, aI as D, a_ as Ta, aU as xc } from "./lib-CEfjsT7q.js";
import { k as Xt, j as Us, g as rn, S as Sc, w as Ic, x as Cc, c as Cl, v as z, y as Nl, l as Nc, z as wc, A as Lc, B as _c, C as bc, a as wl, d as C, i as Ye, r as le, f as $e, D as Y } from "./_baseUniq-CeeXjiQ4.js";
import { j as Bs, m as x, d as Oc, f as Ne, g as Jt, h as N, i as Vs, l as Qt, e as Pc } from "./_basePickBy-CuWLDkTh.js";
import { c as re } from "./clone-BwhQvzM3.js";
...
var He = {}, Cy = {
  info: /* @__PURE__ */ v(async () => {
    const { createInfoServices: n } = await import("./info-63CPKGFF-B15W_ykV.js"), e = n().Info.parser.LangiumParser;
    He.info = e;
  }, "info"),
  packet: /* @__PURE__ */ v(async () => {
    const { createPacketServices: n } = await import("./packet-HUATNLJX-CyVOEiHp.js"), e = n().Packet.parser.LangiumParser;
    He.packet = e;
  }, "packet"),
  pie: /* @__PURE__ */ v(async () => {
    const { createPieServices: n } = await import("./pie-WTHONI2E-BwilbYdG.js"), e = n().Pie.parser.LangiumParser;
    He.pie = e;
  }, "pie"),
  architecture: /* @__PURE__ */ v(async () => {
    const { createArchitectureServices: n } = await import("./architecture-O4VJ6CD3-C2FRf-ur.js"), e = n().Architecture.parser.LangiumParser;
    He.architecture = e;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ v(async () => {
    const { createGitGraphServices: n } = await import("./gitGraph-ZV4HHKMB-1B1um5ot.js"), e = n().GitGraph.parser.LangiumParser;
    He.gitGraph = e;
  }, "gitGraph"),
  radar: /* @__PURE__ */ v(async () => {
    const { createRadarServices: n } = await import("./radar-NJJJXTRR-Bv_xIpJI.js"), e = n().Radar.parser.LangiumParser;
    He.radar = e;
  }, "radar"),
  treemap: /* @__PURE__ */ v(async () => {
    const { createTreemapServices: n } = await import("./treemap-75Q7IDZK-B4SFWGF-.js"), e = n().Treemap.parser.LangiumParser;
    He.treemap = e;
  }, "treemap")
};
